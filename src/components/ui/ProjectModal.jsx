    ...
    >
      ...
      >
        <button
          ...
          className="absolute top-0 right-0 z-20 bg-black text-white transition-colors duration-150 p-2"
          onMouseEnter={e => { e.currentTarget.style.background = COLORS.midText }}
        ...
        <div className="p-8 flex flex-col gap-6 overflow-y-auto" style={{ background: '#fff', margin: '16px', border: '1px solid #000' }}>
          <div>
            <p className="font-mono text-xs mb-1" style={{ color: COLORS.subduedText }}>{project.number}</p>
            <h2
          ...
          <p className="font-mono text-sm leading-relaxed max-w-2xl" style={{ color: COLORS.midText }}>
            {project.description}
          </p>
          ...
          <div className="flex gap-3 pt-2">
            ...
            {project.live && (
              <a
                ...
                className="flex items-center gap-2 text-xs font-mono text-white bg-black px-4 py-2 transition-colors duration-150"
                style={{ border: '1px solid #000', borderRadius: 0 }}
                onMouseEnter={e => { e.currentTarget.style.background = COLORS.midText }}
                onMouseLeave={e => { e.currentTarget.style.background = '#000' }}
              >
